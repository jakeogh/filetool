...
def test__append_bytes_to_file_unique_bytes_binary_mode_skip_existing():
...
def test__append_bytes_to_file_unique_bytes_binary_mode_append_new():
...
def test__append_bytes_to_file_unique_bytes_binary_mode_exact_match():
...
def test__append_bytes_to_file_unique_bytes_binary_mode_substring_match():
...
def test__append_bytes_to_file_unique_bytes_binary_mode_at_start():
...
def test__append_bytes_to_file_unique_bytes_binary_mode_at_end():
...
def test__append_bytes_to_file_unique_bytes_binary_mode_empty_file():
...
def test__append_bytes_to_file_unique_bytes_binary_mode_null_bytes():
...
def test__append_bytes_to_file_unique_bytes_binary_mode_similar_but_different():
...
def test__append_bytes_to_file_unique_bytes_binary_mode_multiple_occurrences():
...
def test__append_bytes_to_file_unique_bytes_binary_vs_line_mode():
